...
import JyverCard from "../../components/userCard/userCard";
...
const LoginPage = () => {
  ...
  const [removeLoadingOverlay, setRemoveLoadingOverlay] = useState(false); 
  ...
  return (
    ...
    <View style={styles.fullScreenContainer}>
      {fontLoaded ? (
        ...
        <View style={styles.loadingContentPlaceholder}>
          <ActivityIndicator size="large" color="lightgreen" />
        </View>
      )}
      {!removeLoadingOverlay && <LoadingScreen loading={showLoadingOverlay} />}
    </View>
  );
};
